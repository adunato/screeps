...
var MAX_DESTINATION_CONTAINER_QUANTITY_PC = 90;
...
var roleCarrier = {
    ...
    run: function (creep) {
        ...
        console.log(creep.room.name + " sourceContainers" + cache.findSourceContainersWithEnergy(creep.getSquad().getSquadRoomName(), MIN_SOURCE_CONTAINER_QUANTITY_PC))
